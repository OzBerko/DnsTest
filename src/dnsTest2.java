...
public class dnsTest2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i<domainParts.length; i++) {
            ...
            System.out.println("length: " + domainBytes.length);
        }
        ...
        System.out.println("baos lenght: " + baos.size());
        byte[] dnsFrame = baos.toByteArray();
        System.out.println("dnsFrame lenght: " + dnsFrame.length);
        ...
        while ((recLen = din.readByte()) > 0) {
            ...
            System.out.println("intial byte array: " + Arrays.toString(record));

            for (int i = 0; i < recLen; i++) {
                record[i] = din.readByte();
                System.out.println("byte array: " + Arrays.toString(record));
            }

            System.out.println("Record: " + new String(record, "UTF-8"));
        }
        */
        //System.out.println("denied recLen: " + din.readByte());
    ...
    public static int plusRR(DataInputStream din) throws IOException{
        int recLen = 0;
        int rrCheck = 0;
        while ((recLen = din.readByte()) > 0) {
        	rrCheck =1;
